...
//        while(stop != true) {
    ...
    private static Estacion crearEstacion() throws CreacionException {
...
//            estacion.setNombre(nombre);
    ...
    private static Sensor crearSensor() {
        Sensor sensor = null;
        int tipo = 0;
        // Ingreso de datos 
        Scanner scan = new Scanner(System.in);
     ...
     */
    private static EstacionBase modificarRed(EstacionBase base) {
        Scanner scan = new Scanner(System.in);
        int seleccion = 0;
        boolean valido = false;
        boolean salir = false;
     ...
     * @return EstacionBase modificada
     */
    private static EstacionBase crearSubRed(EstacionBase base) {
        Scanner scan = new Scanner(System.in);
        int padreID = -1;
        boolean valido = false;
        ...
        while (!valido) {
            ...
            try{
                ...
                // Chequear que sea valido, padreID > 0
     ...
     * @return EstacionBase modificada
     */
    private static EstacionBase eliminarSubRed(EstacionBase base) {
        Scanner scan = new Scanner(System.in);
        int estacionID = -1;
        boolean valido = false;
     ...
     * @return EstacionBase modificada
     */
    private static EstacionBase agregarSensor(EstacionBase base) {
        Scanner scan = new Scanner(System.in);
        int padreID = -1;
        boolean valido = false;
        ...
        while (!valido) {
            ...
            try{
                padreID = scan.nextInt();
                // Chequear que sea valido, padreID > 1
                // Por ahi si la red puede llegar a ser muy grande tambien poner
                // como condicion que sea menor que 1000 (ID base de sensor).
                if (padreID < 1)
                    throw new InputMismatchException();
     ...
     * @return EstacionBase modificada
     */
    private static EstacionBase eliminarSensor(EstacionBase base) {
        Scanner scan = new Scanner(System.in);
        int sensorID = -1;
        boolean valido = false;
